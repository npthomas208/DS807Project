...
nn$testimage$y = list(as.integer(outer(readJPEG("Images/Test/OIP.jfif"),  255)))

nn$tarray <- function(x) aperm(x, seq_along(dim(x)))
nn$test$x = nn$tarray(array(unlist(nn$testimage$y), c(length(nn$testimage$y),1024, 1024, 3)))
