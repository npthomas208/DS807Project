---
title:  "DS807 Presentation -  </br>Blue Jay Image Analysis"
...
Purpose: Using the methods we have learned in this class, through trial and error, we will look at the usefulness of a selection for image analysis (object detection and object identification).
...
Clustering can be used to analyze the number of potentially distinct colors - though clustering fails to perform object detection or identification. 
...
Further example of how clustering is not capable of object detection or identification.
...
Used stepFlexmix to determine optimal number of Gaussian color distributions. Optimized based on BIC.
...
Also, thank you everyone for being an integral part of this first cohort in the UNH MSBA program! 

Best of luck UNH MSBA Class of 2021 in all future endeavors!