...
* Deep learning techniques are the only viable set of algorithms for object detection
...
* Keras/Tensorflow is not ideal for object detection when the test set is small.
